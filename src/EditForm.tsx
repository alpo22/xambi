...
export function EditForm(props: EditFormProps) {
  ...
  useEffect(() => {
    const currListFieldSize = props.editEntries.map(entry => {
      const isArrField =
        props.entityObj && (entry.type === EditEntryType.TextList || entry.type === EditEntryType.DoubleTextList);
      return isArrField
        ...
        onSubmit={event => {
          ...
          for (const editEntry of props.editEntries) {
            ...
            if (editEntry.type === EditEntryType.Article) {
              ...
              const mandatoryFilledCount = [article["title"], article["content"], article["image_url"]].filter(
                e => e
              ).length;
            ...
            if (editEntry.type === EditEntryType.Showcase) {
              ...
              let filledCount = [showcase["title"], numPhotos > 0].filter(e => e).length;

              if (isInstagramShowcase) {
                filledCount += [showcase["handle"], showcase["url"], showcase["profile_photo_url"]].filter(
                  e => e
                ).length;
              }
              ...
              if (filledCount > 0 && filledCount < numRequiredFields) {
                toast.error(
                  `Title${isInstagramShowcase ? ", Handle, Profile URL, Profile Photo," : ""} and Images are required for ${editEntry.attributeName}.`
                );
                return;
              }
            }
                  ...
                  return (
                    <div className="col-span-6 sm:col-span-3">
                      <label htmlFor={editEntry.attribute} className="block text-sm font-medium text-gray-700">
                        ...
                        {editEntry.subName && <span className="block text-xs text-gray-500">{editEntry.subName}</span>}
                      </label>
                      <div className="my-2">
                        <input
                      ...
                      {editEntry.info && <p className="text-sm text-gray-500">{editEntry.info}</p>}
                    </div>
                  );
                        ...
                        return (
                          <div className="my-2">
                            <input
                              ...
                              type="text"
                              defaultValue={
                                entity && entity[editEntry.attribute] && entity[editEntry.attribute][i]
                  ...
                  return (
                    <div className="col-span-6">
                      ...
                      <div className="col-span-6 pb-2">
                        ...
                        {editEntry.subName && <p className="text-sm text-gray-500">{editEntry.subName}</p>}
                      </div>
                      {Array.from(Array(listFieldSize[index]).keys()).map(i => {
                        return (
                          <>
                    ...
                    <div className="col-span-6">
                      ...
                      <div className="my-2">
                        ...
                        {editEntry.characterCount && (
                          ...
                          >
                            Character Count:{" "}
                            {characterCounts[editEntry.attribute] ? characterCounts[editEntry.attribute] : 0}/
                            {editEntry.characterCount}
                          </p>
                        )}
                      </div>
                  ...
                  return (
                    <div className="col-span-6">
                      ...
                      <div className="col-span-6 pb-2">
                        ...
                        {editEntry.subName && <p className="text-xs text-gray-500">{editEntry.subName}</p>}
                      </div>
                      {/* <label htmlFor={editEntry.attribute} className="block text-sm font-medium text-gray-700">
                          Tagline
                        </label>
                      ...
                      <div className="my-2">
                        <input
                          ...
                          type="text"
                          defaultValue={
                            entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["title"] : ""
                          }
                          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        />
                      </div>
                      ...
                      <div className="my-2">
                        <input
                          ...
                          type="text"
                          defaultValue={
                            entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["subtitle"] : ""
                          }
                          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        />
                      </div>
                      ...
                      <div className="my-2">
                        <textarea
                          ...
                          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                          defaultValue={
                            entity && entity[editEntry.attribute] && entity[editEntry.attribute]["content"]
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          ...
                          <div className="my-2">
                            <input
                              ...
                              defaultValue={
                                entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["city"] : ""
                              }
                              autoComplete="city"
                              className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            />
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          ...
                          <div className="my-2">
                            <input
                              ...
                              defaultValue={
                                entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["province"] : ""
                              }
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          ...
                          <div className="my-2">
                            <input
                              ...
                              defaultValue={
                                entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["postal_code"] : ""
                              }
                            ...
                            <div className="col-span-6 sm:col-span-3">
                              ...
                              <div className="my-2">
                                <input
                                  ...
                                  placeholder="@"
                                  defaultValue={
                                    entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["handle"] : ""
                                  }
                                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                />
                              </div>
                            ...
                            <div className="col-span-6 sm:col-span-3">
                              ...
                              <div className="my-2">
                                <input
                                  ...
                                  defaultValue={
                                    entity && entity[editEntry.attribute] ? entity[editEntry.attribute]["url"] : ""
                                  }
                                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                />
                              </div>
                            ...
                            <div className="my-2 flex items-center">
                              <span className="h-12 w-12 overflow-hidden rounded-full bg-gray-300">
                                {uploadPhotoMap[editEntry.attribute + "_profile_photo_url"] ? (
                                  <img
                                    className="object-cover aspect-square"
                                    src={uploadPhotoMap[editEntry.attribute + "_profile_photo_url"]}
                                    alt=""
                                  />
                                ) : entity &&
                                  entity[editEntry.attribute] &&
